...
public class UserController {
    ...
    public ResponseEntity<?> saveUser(@RequestBody User user) {
        return userService.saveUser(user); // ✅ Correct usage of the injected service
    }
	...
	@GetMapping("/users/search/name/{letter}")
	...
	/*
	 * @DeleteMapping("/users/{id}") public ResponseEntity<?>
	 * deleteUser(@PathVariable int id) { return userService.deleteUser(id); }
	 */
